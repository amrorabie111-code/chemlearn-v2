...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Zap, User } from 'lucide-react';
...
export const SignupScreen: React.FC<SignupScreenProps> = ({ onSwitchToLogin }) => {
  ...
  return (
    <>
      <LoadingBar isLoading={isLoading} message="Creating your account..." />
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-3xl text-white mb-2">{t.signup}</h1>
          <p className="text-on-surface-variant text-sm">Start your chemistry journey today</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={`Create a ${t.password.toLowerCase()}`}
